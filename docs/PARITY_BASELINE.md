...
| Settings/accessibility | Svelte settings and browser semantics | Native provider drawer and command palette foundation; remaining settings and AT-SPI pending |
