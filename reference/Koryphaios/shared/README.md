...
Current provider-specific reasoning parameter mappings implemented by this package:
...
2. **Update shared helpers and exports together** — Keep type and utility changes in sync
...
Avoid hardcoding backend URLs or WebSocket ports in consumers. Prefer the shared config helpers and app config files instead.
